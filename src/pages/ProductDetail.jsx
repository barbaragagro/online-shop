...
export default function ProductDetail() {
  ...
  useEffect(() => {
    const getProductDetail = () => {
      if (Url) {
        const result = data.filter((product) => product.url === Url);
        setProduct(result[0]);
      }
    };
      ...
      <div className="flex flex-col justify-between m-5 p-5 rounded-lg shadow-xl bg-custompaleorange bg-opacity-40 ">
        ...
        <div className="flex flex-col mt-5 shadow-lg rounded-lg">
          ...
          <div className='flex lg:flex-row flex-col lg:m-10'>
            <button className="font-bold lg:text-2xl justify-center hover:scale-105 transition-all hover:bg-opacity-95 text-customdarkblue rounded-lg mx-5 px-5 py-2 lg:mt-0 mt-5 mb-5 self-center  bg-customorange items-center w-3/4 lg:w-1/2 h-12 lg:h-24 ">
              Go back
            </button>
            <button className="flex font-bold lg:text-2xl justify-center hover:scale-105 transition-all hover:bg-opacity-95 text-custompaleorange rounded-lg mx-5 px-5 py-2 mb-5 self-center  bg-customdarkblue items-center w-3/4 lg:w-1/2  h-12 lg:h-24 ">
